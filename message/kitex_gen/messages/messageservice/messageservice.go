...
func messageChatHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(messages.DouyinMessageChatRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(messages.MessageService).MessageChat(ctx, req)
		if err != nil {
			return err
		}
	...
	case *MessageChatArgs:
		success, err := handler.(messages.MessageService).MessageChat(ctx, s.Req)
		if err != nil {
			return err
		}
...
type MessageChatArgs struct {
	Req *messages.DouyinMessageChatRequest
}

func (p *MessageChatArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(messages.DouyinMessageChatRequest)
	}
...
func (p *MessageChatArgs) Unmarshal(in []byte) error {
	...
	msg := new(messages.DouyinMessageChatRequest)
...
var MessageChatArgs_Req_DEFAULT *messages.DouyinMessageChatRequest

func (p *MessageChatArgs) GetReq() *messages.DouyinMessageChatRequest {
	if !p.IsSetReq() {
...
type MessageChatResult struct {
	Success *messages.DouyinMessageChatResponse
}

var MessageChatResult_Success_DEFAULT *messages.DouyinMessageChatResponse

func (p *MessageChatResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(messages.DouyinMessageChatResponse)
	}
...
func (p *MessageChatResult) Unmarshal(in []byte) error {
	...
	msg := new(messages.DouyinMessageChatResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *MessageChatResult) GetSuccess() *messages.DouyinMessageChatResponse {
	if !p.IsSetSuccess() {
...
func (p *MessageChatResult) SetSuccess(x interface{}) {
	p.Success = x.(*messages.DouyinMessageChatResponse)
}
...
func messageActionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(messages.DouyinRelationActionRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(messages.MessageService).MessageAction(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *MessageActionArgs:
		success, err := handler.(messages.MessageService).MessageAction(ctx, s.Req)
		if err != nil {
			return err
		}
...
type MessageActionArgs struct {
	Req *messages.DouyinRelationActionRequest
}

func (p *MessageActionArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(messages.DouyinRelationActionRequest)
	}
	return p.Req.FastRead(buf, _type, number)
}
...
func (p *MessageActionArgs) Unmarshal(in []byte) error {
	...
	msg := new(messages.DouyinRelationActionRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var MessageActionArgs_Req_DEFAULT *messages.DouyinRelationActionRequest

func (p *MessageActionArgs) GetReq() *messages.DouyinRelationActionRequest {
	if !p.IsSetReq() {
...
type MessageActionResult struct {
	Success *messages.DouyinRelationActionResponse
}

var MessageActionResult_Success_DEFAULT *messages.DouyinRelationActionResponse

func (p *MessageActionResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(messages.DouyinRelationActionResponse)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *MessageActionResult) Unmarshal(in []byte) error {
	...
	msg := new(messages.DouyinRelationActionResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *MessageActionResult) GetSuccess() *messages.DouyinRelationActionResponse {
	if !p.IsSetSuccess() {
...
func (p *MessageActionResult) SetSuccess(x interface{}) {
	p.Success = x.(*messages.DouyinRelationActionResponse)
}
...
func (p *kClient) MessageChat(ctx context.Context, Req *messages.DouyinMessageChatRequest) (r *messages.DouyinMessageChatResponse, err error) {
...
func (p *kClient) MessageAction(ctx context.Context, Req *messages.DouyinRelationActionRequest) (r *messages.DouyinRelationActionResponse, err error) {
